...
// const tempArr = categoryList.reduce(
//   (a, b) => (b.categorys ? [...a, ...b.categorys] : [...a, b]),
//   []
// );
//   .forEach(
//     (item) =>
//       (cateSelecElem.innerHTML += `<option value="${tempArr[i].href}">${tempArr[i].name}</option>`)
//   );
const tempArr = [...categoryList];
const cateSelecElem = document.getElementById("category");
  ...
  listElem.innerHTML += `<li>
                    <a href="">
                      <div class="item">
                        ...
                        <div class="img">
                          <img src="./imgs/icon-community-lol-v2.png">
                        </div>
                      </div>
                    </a>
                  </li>`;
